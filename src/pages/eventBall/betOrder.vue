...
export default defineComponent({
    ...
    setup(props) {
        const { model, betStore, isSingle, getBetCount, getBetTotalAmount, getEstimatedBonus, addOrder, flolowOrder } = useBet()
        ...
        return { model, betStore, betOrderStore, isSingle, clearOrder, delBetEvent, getBetCount, getBetTotalAmount, getEstimatedBonus, addOrderEvent, flolowOrderEvent, Utils }
    }
})
</script>
