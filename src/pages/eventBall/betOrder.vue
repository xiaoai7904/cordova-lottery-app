...
import { XA_DEL_BET, Utils } from 'src/common'
...
export default defineComponent({
    ...
    setup() {
        const { model, betStore, getBetCount, getBetTotalAmount, getEstimatedBonus } = useBet()
        ...
        return { model, betStore, betOrderStore, clearOrder, delBetEvent, getBetCount, getBetTotalAmount, getEstimatedBonus, Utils }
    }
})
</script>
