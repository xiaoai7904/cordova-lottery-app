      ...
      <div class="bottom">
        <div class="game-item">
          ...
          <div class="bet-item">
            ...
            <div class="item">胜平 <span>2.00</span></div>
            <div class="item">胜负 <span>2.00</span></div>
            <div class="item">平胜 <span>2.00</span></div>
            <div class="item">平负 <span>2.00</span></div>
            <div class="item">负胜 <span>2.00</span></div>
            <div class="item">负平 <span>2.00</span></div>
            <div class="item">负负 <span>2.00</span></div>
          </div>
          <!--选择值-->
          <div class="number-box">
            <span>平平<br />5.70</span>
          </div>
        </div>
        <div
          class="right-icon"
          @click="() => (model.showEvent = !model.showEvent)"
        >
